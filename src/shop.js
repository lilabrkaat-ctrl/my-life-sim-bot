...
const SHOP = {
    offices: [
        { id: 1, name: "خونه پدری", price: 0, capacity: 3, staffCapacity: 0, emoji: "🏚️", prestige: 1 },
        { id: 2, name: "دفتر کوچیک", price: 50, capacity: 5, staffCapacity: 1, emoji: "🏠", prestige: 2 },
        { id: 3, name: "دفتر شیک", price: 200, capacity: 8, staffCapacity: 2, emoji: "🏢", prestige: 3 },
        { id: 4, name: "ساختمان", price: 1000, capacity: 15, staffCapacity: 4, emoji: "🏬", prestige: 4 },
        { id: 5, name: "برج", price: 5000, capacity: 30, staffCapacity: 8, emoji: "🌆", prestige: 5 }
    ],
    vehicles: [
    ...
    facilities: [
        ...
        { id: 5, name: "آکادمی", price: 1000, bonus: 0, emoji: "🏟️", desc: "بازیکن رایگان" }
    ],
    staff: [
        { id: 1, name: "منشی", price: 10, emoji: "👩‍💼", desc: "پیشنهاد خودکار", needOffice: 2 },
        { id: 2, name: "مربی", price: 20, emoji: "👨‍🏫", desc: "هفته‌ای +۱", needOffice: 3 },
