...
const dialogues = {
    ...
    bandit_female: {
        ...
        harem: [
            ...
            { text: "🦹‍♀️ دلم می‌خواد دوباره دزدی کنم", options: [{ text: "🚫 نه", action: "ally" }, { text: "💋 بمون", action: "kiss" }, { text: "🔥 بیا", action: "seduce" }] }
        ]
    },
    singer: {
        day1: [
            { text: "👩‍🎤 می‌خوای برات آواز بخونم؟", options: [{ text: "🎵 بخون", action: "listen" }, { text: "💋 عشق", action: "seduce" }, { text: "🏃 برو", action: "flee" }] },
            { text: "👩‍🎤 صدای من قلبت رو تسخیر می‌کنه", options: [{ text: "🎵 تسخیر کن", action: "listen" }, { text: "💋 تسخیر شدم", action: "seduce" }, { text: "🏃 برو", action: "flee" }] }
        ],
        day2: [
            { text: "👩‍🎤 دیشب برات آهنگ عاشقونه نوشتم", options: [{ text: "🎵 بخون", action: "listen" }, { text: "💋 برام؟", action: "kiss" }, { text: "🏃 فرار", action: "flee" }] },
            { text: "👩‍🎤 وقتی می‌خونم... دنیا مال منه", options: [{ text: "🎵 بخون", action: "listen" }, { text: "💋 مال منی", action: "seduce" }, { text: "🏃 فرار", action: "flee" }] }
        ],
        day3: [
            { text: "👩‍🎤 می‌خوای برات خصوصی بخونم؟", options: [{ text: "🏠 بیا", action: "ally" }, { text: "💋 خصوصی", action: "seduce" }, { text: "🔙 بعداً", action: "flee" }] },
            { text: "👩‍🎤 آوازهای من عاشقت می‌کنن", options: [{ text: "💋 شدم", action: "kiss" }, { text: "🎵 بخون", action: "listen" }, { text: "🔙 بعداً", action: "flee" }] }
        ],
        day4: [
            { text: "👩‍🎤 هیچ‌کس مثل تو درکم نکرده", options: [{ text: "💋 درک می‌کنم", action: "kiss" }, { text: "🎵 ادامه بده", action: "listen" }, { text: "🔙 بعداً", action: "flee" }] },
            { text: "👩‍🎤 دلم می‌خواد تا صبح برات بخونم", options: [{ text: "🎵 بخون", action: "listen" }, { text: "💋 تا صبح", action: "seduce" }, { text: "🔙 بعداً", action: "flee" }] }
        ],
        day5: [
            { text: "👩‍🎤 عاشقتم... می‌خوام توی آوازم بگم", options: [{ text: "💋 بگو", action: "kiss" }, { text: "🎵 بخون", action: "listen" }, { text: "🎁 هدیه", action: "gift" }] },
            { text: "👩‍🎤 صدای من فقط برای توئه", options: [{ text: "💋 برای من", action: "kiss" }, { text: "🔥 بیا", action: "seduce" }, { text: "🔙 بعداً", action: "flee" }] }
        ],
        day6: [
            { text: "👩‍🎤 امروز برات آواز خاص می‌خونم", options: [{ text: "🔥 از جلو", action: "seduce" }, { text: "🍑 از پشت", action: "seduce" }, { text: "👄 دهنی", action: "kiss" }] },
            { text: "👩‍🎤 موسیقی عشق... با ساز بدنمون", options: [{ text: "🔥 بزن", action: "seduce" }, { text: "💋 آروم", action: "kiss" }, { text: "🔙 بعداً", action: "flee" }] }
        ],
        day7: [
            { text: "👩‍🎤 تا ابد برات می‌خونم", options: [{ text: "💋 تا ابد", action: "kiss" }, { text: "👰 ازدواج", action: "propose" }, { text: "🔥 بیا", action: "seduce" }] },
            { text: "👩‍🎤 آواز آخر... آواز عشق ابدی", options: [{ text: "🎵 بخون", action: "listen" }, { text: "💋 ببوس", action: "kiss" }, { text: "👶 بچه‌دار شیم", action: "seduce" }] }
        ],
        harem: [
            { text: "👩‍🎤 شوهرم... برات یه آهنگ جدید نوشتم", options: [{ text: "🎵 بخون", action: "listen" }, { text: "🔥 سکس", action: "seduce" }, { text: "🔙 بعداً", action: "flee" }] },
            { text: "👩‍🎤 امشب کنسرت خصوصی داریم", options: [{ text: "🎤 بیا", action: "ally" }, { text: "💋 منتظرم", action: "kiss" }, { text: "🔥 بکنم", action: "seduce" }] }
        ]
    },
    genie: {
        day1: [
            { text: "🧝‍♀️ آزادم کردی! ۳ تا آرزو می‌تونی بکنی", options: [{ text: "💎 ثروت", action: "wealth" }, { text: "⚔️ قدرت", action: "power" }, { text: "💋 عشق", action: "seduce" }] },
            { text: "🧝‍♀️ من جن صحرام... هر آرزویی برآورده میشه", options: [{ text: "💋 عشق", action: "seduce" }, { text: "💰 پول", action: "wealth" }, { text: "🏃 فرار", action: "flee" }] }
        ],
        day2: [
            { text: "🧝‍♀️ آرزوی دومت چیه؟", options: [{ text: "⚔️ قدرت", action: "power" }, { text: "💋 تو", action: "seduce" }, { text: "🏃 فرار", action: "flee" }] },
            { text: "🧝‍♀️ می‌دونی جن‌ها چقدر قدرتمندن؟", options: [{ text: "👂 بگو", action: "listen" }, { text: "💋 نشون بده", action: "seduce" }, { text: "🏃 فرار", action: "flee" }] }
        ],
        day3: [
            { text: "🧝‍♀️ آرزوی سوم رو خودم انتخاب کنم؟", options: [{ text: "💋 انتخاب کن", action: "seduce" }, { text: "🤝 باشه", action: "ally" }, { text: "🔙 بعداً", action: "flee" }] },
            { text: "🧝‍♀️ می‌تونم عشق رو واقعی کنم", options: [{ text: "💋 عشق", action: "kiss" }, { text: "🔮 واقعی کن", action: "wish" }, { text: "🔙 بعداً", action: "flee" }] }
        ],
        day4: [
            { text: "🧝‍♀️ تا حالا عاشق نشدم... ولی تو", options: [{ text: "💋 عاشق شو", action: "kiss" }, { text: "🤝 چرا؟", action: "listen" }, { text: "🔙 بعداً", action: "flee" }] },
            { text: "🧝‍♀️ می‌خوام پیشت بمونم... به عنوان زن", options: [{ text: "💋 بمون", action: "kiss" }, { text: "🔥 زن من", action: "seduce" }, { text: "🔙 بعداً", action: "flee" }] }
        ],
        day5: [
            { text: "🧝‍♀️ قدرتم رو فدای عشقت می‌کنم", options: [{ text: "💋 نمی‌خوام", action: "kiss" }, { text: "🤝 فدا نکن", action: "ally" }, { text: "🎁 هدیه", action: "gift" }] },
            { text: "🧝‍♀️ ۱۰۰۰ ساله زنده‌ام... این ۳ روز بهترین بود", options: [{ text: "💋 عاشقتم", action: "kiss" }, { text: "🔥 بیا", action: "seduce" }, { text: "🔙 بعداً", action: "flee" }] }
        ],
        day6: [
            { text: "🧝‍♀️ امروز تمام جادوم رو برات", options: [{ text: "🔥 از جلو", action: "seduce" }, { text: "🍑 از پشت", action: "seduce" }, { text: "👄 دهنی", action: "kiss" }] },
            { text: "🧝‍♀️ جادوی عشق قوی‌ترین جادوست", options: [{ text: "💋 جادو کن", action: "kiss" }, { text: "🔥 بکنم", action: "seduce" }, { text: "🔙 بعداً", action: "flee" }] }
        ],
        day7: [
            { text: "🧝‍♀️ تا ابد مال تو", options: [{ text: "💋 مال منی", action: "kiss" }, { text: "👰 ازدواج", action: "propose" }, { text: "🔥 بیا", action: "seduce" }] },
            { text: "🧝‍♀️ آخرین آرزوم... عاشقت بمونم", options: [{ text: "💋 تا ابد", action: "kiss" }, { text: "🔥 بکنم", action: "seduce" }, { text: "👶 بچه جن", action: "seduce" }] }
        ],
        harem: [
            { text: "🧝‍♀️ شوهرم... امروز ۳ تا آرزو داری", options: [{ text: "💋 آرزوی تو", action: "kiss" }, { text: "💰 ثروت", action: "wealth" }, { text: "🔙 بعداً", action: "flee" }] },
            { text: "🧝‍♀️ برات یه طلسم خوش‌شانسی درست کردم", options: [{ text: "✨ ممنون", action: "ally" }, { text: "💋 عاشقتم", action: "kiss" }, { text: "🔥 امتحان کن", action: "seduce" }] }
        ]
    }
};
    ...
    young_witch: {
        day1: [
            ...
            { text: "🧙‍♀️ من شاگرد جادوگرم... ولی ازش بهترم!", options: [{ text: "👂 بگو", action: "listen" }, { text: "💋 نشون بده", action: "seduce" }, { text: "🏃 برو", action: "flee" }] }
        ],
        day2: [
            { text: "🧙‍♀️ دیشب یه طلسم جدید یاد گرفتم", options: [{ text: "🧪 امتحان کن", action: "potion" }, { text: "💋 روی من؟", action: "seduce" }, { text: "🏃 فرار", action: "flee" }] },
            { text: "🧙‍♀️ استادم می‌گه جادوگرا نباید عاشق بشن", options: [{ text: "💋 عاشق شو", action: "seduce" }, { text: "🤝 چرا؟", action: "listen" }, { text: "🏃 فرار", action: "flee" }] }
        ],
        day3: [
            { text: "🧙‍♀️ می‌خوام طلسم عشق رو امتحان کنم", options: [{ text: "💋 نترس", action: "kiss" }, { text: "🧪 امتحان کن", action: "potion" }, { text: "🔙 بعداً", action: "flee" }] },
            { text: "🧙‍♀️ تو می‌تونی اولین عشق من باشی", options: [{ text: "💋 باشم", action: "kiss" }, { text: "🤝 افتخار", action: "ally" }, { text: "🔙 بعداً", action: "flee" }] }
        ],
        day4: [
            { text: "🧙‍♀️ طلسم عشق جواب داد", options: [{ text: "💋 دیوونه شو", action: "kiss" }, { text: "🔥 بکنم", action: "seduce" }, { text: "🔙 بعداً", action: "flee" }] },
            { text: "🧙‍♀️ استادم اگه بفهمه", options: [{ text: "🤝 نمی‌فهمه", action: "ally" }, { text: "💋 مهم نیست", action: "kiss" }, { text: "🔙 بعداً", action: "flee" }] }
        ],
        day5: [
            { text: "🧙‍♀️ دیگه شاگرد نیستم... زن تو هستم", options: [{ text: "💋 زن من", action: "kiss" }, { text: "🔥 بیا", action: "seduce" }, { text: "🎁 هدیه", action: "gift" }] },
            { text: "🧙‍♀️ برات معجون عشق درست کردم", options: [{ text: "🧪 بخوریم", action: "potion" }, { text: "💋 اول ببوس", action: "kiss" }, { text: "🔙 بعداً", action: "flee" }] }
        ],
        day6: [
            { text: "🧙‍♀️ امروز جادوی عشق رو یادت می‌دم", options: [{ text: "🔥 از جلو", action: "seduce" }, { text: "🍑 از پشت", action: "seduce" }, { text: "👄 دهنی", action: "kiss" }] },
            { text: "🧙‍♀️ جادوی بدن قوی‌تر از کتاباست", options: [{ text: "🔥 جادو کن", action: "seduce" }, { text: "💋 آروم", action: "kiss" }, { text: "🔙 بعداً", action: "flee" }] }
        ],
        day7: [
            { text: "🧙‍♀️ تا ابد شاگرد عشق تو", options: [{ text: "💋 شاگردم", action: "kiss" }, { text: "👰 ازدواج", action: "propose" }, { text: "🔥 بیا", action: "seduce" }] },
            { text: "🧙‍♀️ استاد عشق... تویی", options: [{ text: "💋 استادت", action: "kiss" }, { text: "🔥 بکنم", action: "seduce" }, { text: "👶 بچه جادوگر", action: "seduce" }] }
        ],
        harem: [
            { text: "🧙‍♀️ شوهرم... امروز یه طلسم جدید کشف کردم", options: [{ text: "🔮 نشون بده", action: "ally" }, { text: "💋 عالیه", action: "kiss" }, { text: "🔙 بعداً", action: "flee" }] },
            { text: "🧙‍♀️ می‌خوام برات یه معجون مخصوص بسازم", options: [{ text: "🧪 بساز", action: "potion" }, { text: "💋 ممنون", action: "kiss" }, { text: "🔥 بنوش", action: "seduce" }] }
        ]
    },
    ghost_sexy: {
        day1: [
    ...
    wizard: {
        day1: [
            ...
            { text: "🧙‍♂️ قدرت زیاد می‌خوای؟ باید هزینه‌اش رو بدی", options: [{ text: "💰 می‌پردازم", action: "wealth" }, { text: "🗡️ نمی‌خوام", action: "fight" }, { text: "💋 باشه", action: "seduce" }] }
        ],
        day2: [
            { text: "🧙‍♂️ دوباره تو؟! هنوز زنده‌ای؟", options: [{ text: "💋 زنده‌ام", action: "seduce" }, { text: "🔮 طلسم", action: "potion" }, { text: "🏃 فرار", action: "flee" }] },
            { text: "🧙‍♂️ توی کریستالم دیدمت", options: [{ text: "👂 چی دیدی؟", action: "listen" }, { text: "💋 عاشقمی؟", action: "seduce" }, { text: "🏃 فرار", action: "flee" }] }
        ],
        day3: [
            { text: "🧙‍♂️ می‌تونم بهت قدرت بدم", options: [{ text: "🤝 چی کار کنم؟", action: "ally" }, { text: "💋 خودت رو می‌خوام", action: "seduce" }, { text: "🔙 بعداً", action: "flee" }] },
            { text: "🧙‍♂️ جادوی من دنیا رو تغییر میده", options: [{ text: "🔮 یاد بده", action: "potion" }, { text: "💋 تغییر بده", action: "seduce" }, { text: "🔙 بعداً", action: "flee" }] }
        ],
        day4: [
            { text: "🧙‍♂️ هیچکس مثل تو جادوی منو درک نکرده", options: [{ text: "💋 درک می‌کنم", action: "kiss" }, { text: "🤝 دوست", action: "ally" }, { text: "🔙 بعداً", action: "flee" }] },
            { text: "🧙‍♂️ دلم می‌خواد جادوی عشق رو امتحان کنم", options: [{ text: "💋 امتحان کن", action: "kiss" }, { text: "🧪 باهم", action: "potion" }, { text: "🔙 بعداً", action: "flee" }] }
        ],
        day5: [
            { text: "🧙‍♂️ قدرتم رو با تو تقسیم می‌کنم", options: [{ text: "💋 ممنون", action: "kiss" }, { text: "⚔️ قدرت", action: "power" }, { text: "🎁 هدیه", action: "gift" }] },
            { text: "🧙‍♂️ عاشقتم... این قوی‌ترین جادوی منه", options: [{ text: "💋 منم عاشقتم", action: "kiss" }, { text: "🔥 بیا", action: "seduce" }, { text: "🔙 بعداً", action: "flee" }] }
        ],
        day6: [
            ...
            { text: "🧙‍♂️ طلسم عشق قوی‌ترین طلسمه", options: [{ text: "🔥 طلسم کن", action: "seduce" }, { text: "💋 ببوس", action: "kiss" }, { text: "🔙 بعداً", action: "flee" }] }
        ],
        day7: [
            { text: "🧙‍♂️ تا ابد جادوگر تو می‌مونم", options: [{ text: "💋 تا ابد", action: "kiss" }, { text: "👰 ازدواج جادویی", action: "propose" }, { text: "🔥 بیا", action: "seduce" }] },
            { text: "🧙‍♂️ آخرین طلسم... طلسم عشق ابدی", options: [{ text: "🔮 بزن", action: "potion" }, { text: "💋 ببوس", action: "kiss" }, { text: "👶 بچه جادوگر", action: "seduce" }] }
        ],
        harem: [
    ...
    jester: {
        day1: [
            { text: "🎭 اگه بخندی جایزه داری، نخندی دو تا!", options: [{ text: "😂 می‌خندم", action: "gift" }, { text: "😐 نمی‌خندم", action: "fight" }, { text: "💋 نشون بده", action: "seduce" }] },
            { text: "🎭 شوخی کردم! فقط می‌خواستم ببینم زنده‌ای", options: [{ text: "😂 زنده‌ام", action: "ally" }, { text: "💋 خنده‌دار بود", action: "seduce" }, { text: "🏃 فرار", action: "flee" }] }
        ],
        day2: [
            { text: "🎭 امروز یه لطیفه جدید یاد گرفتم", options: [{ text: "👂 بگو", action: "listen" }, { text: "😂 بگو", action: "gift" }, { text: "💋 بگو", action: "seduce" }] },
            { text: "🎭 می‌دونی چرا دلقک‌ها گریه نمی‌کنن؟", options: [{ text: "👂 چرا؟", action: "listen" }, { text: "💋 نمی‌دونم", action: "seduce" }, { text: "😂 احمقانه‌ست", action: "gift" }] }
        ],
        day3: [
            { text: "🎭 پشت این نقاب یه قلب واقعی هست", options: [{ text: "💋 می‌دونم", action: "kiss" }, { text: "🤝 دروغه", action: "ally" }, { text: "🔙 بعداً", action: "flee" }] },
            { text: "🎭 من فقط مردم رو می‌خندونم... ولی خودم", options: [{ text: "💋 غمگینی؟", action: "kiss" }, { text: "🤝 چته؟", action: "ally" }, { text: "🔙 بعداً", action: "flee" }] }
        ],
        day4: [
            { text: "🎭 تو تنها کسی هستی که منو جدی می‌گیری", options: [{ text: "💋 جدی‌ام", action: "kiss" }, { text: "🤝 آره", action: "ally" }, { text: "🔙 بعداً", action: "flee" }] },
            { text: "🎭 می‌خوام بدون نقاب باشم... فقط برای تو", options: [{ text: "💋 بدون نقاب", action: "kiss" }, { text: "🔥 بیا", action: "seduce" }, { text: "🔙 بعداً", action: "flee" }] }
        ],
        day5: [
            { text: "🎭 عاشق شدم... این دیگه شوخی نیست", options: [{ text: "💋 جدیه", action: "kiss" }, { text: "😂 شوخیه", action: "gift" }, { text: "🎁 هدیه", action: "gift" }] },
            { text: "🎭 می‌خوام تا ابد بخندونمت", options: [{ text: "💋 بخندون", action: "kiss" }, { text: "🔥 بیا", action: "seduce" }, { text: "🔙 بعداً", action: "flee" }] }
        ],
        day6: [
            { text: "🎭 امروز شوخی نداریم... فقط عشق", options: [{ text: "🔥 از جلو", action: "seduce" }, { text: "🍑 از پشت", action: "seduce" }, { text: "👄 دهنی", action: "kiss" }] },
            { text: "🎭 بهترین شوخی دنیا... عشق ماست", options: [{ text: "💋 بهترین", action: "kiss" }, { text: "🔥 بکنم", action: "seduce" }, { text: "🔙 بعداً", action: "flee" }] }
        ],
        day7: [
            { text: "🎭 تا ابد دلقک عاشق تو", options: [{ text: "💋 تا ابد", action: "kiss" }, { text: "👰 ازدواج", action: "propose" }, { text: "🔥 بیا", action: "seduce" }] },
            { text: "🎭 آخرین شوخی... شوخی با سرنوشت", options: [{ text: "💋 بذار", action: "kiss" }, { text: "🔥 بکنم", action: "seduce" }, { text: "👶 بچه‌دار شیم", action: "seduce" }] }
        ],
        harem: [
            { text: "🎭 شوهرم... امروز یه لطیفه جدید دارم", options: [{ text: "😂 بگو", action: "listen" }, { text: "💋 بگو", action: "kiss" }, { text: "🔙 بعداً", action: "flee" }] }
        ]
    },
    prince: {
        day1: [
            { text: "🤴 میدونی من کیم؟! شاهزاده‌ام!", options: [{ text: "🤝 کمک", action: "help" }, { text: "💰 گروگان", action: "fight" }, { text: "💋 تصاحب", action: "seduce" }] },
            { text: "🤴 از کاخ فرار کردم... نمی‌خوام برگردم", options: [{ text: "🤝 بمون", action: "ally" }, { text: "💋 پیشم بمون", action: "seduce" }, { text: "🏃 فرار", action: "flee" }] }
        ],
        day2: [
            { text: "🤴 اینجا از کاخ بهتره... آزادی دارم", options: [{ text: "🤝 خوشحالم", action: "ally" }, { text: "💋 خوشحالی", action: "seduce" }, { text: "🏃 فرار", action: "flee" }] },
            { text: "🤴 تو مثل بقیه نیستی... منو برای پول نمی‌خوای", options: [{ text: "💋 نمی‌خوام", action: "kiss" }, { text: "🤝 آره", action: "ally" }, { text: "🏃 فرار", action: "flee" }] }
        ],
        day3: [
            { text: "🤴 می‌تونم بهت لقب شوالیه بدم", options: [{ text: "⚔️ شوالیه", action: "power" }, { text: "💋 چیز دیگه", action: "seduce" }, { text: "🔙 بعداً", action: "flee" }] },
            { text: "🤴 کاخ پدرم پر از طلاست", options: [{ text: "💰 بگو کجاست", action: "treasure" }, { text: "💋 طلا نمی‌خوام", action: "seduce" }, { text: "🔙 بعداً", action: "flee" }] }
        ],
        day4: [
            { text: "🤴 دلم برات تنگ شده... چرا دیر میای؟", options: [{ text: "💋 مشغول بودم", action: "kiss" }, { text: "🤝 گرفتار بودم", action: "ally" }, { text: "🔙 بعداً", action: "flee" }] },
            { text: "🤴 می‌خوام یه روز برگردم کاخ... با تو", options: [{ text: "💋 با هم", action: "kiss" }, { text: "🤝 تنهایی", action: "ally" }, { text: "🔙 بعداً", action: "flee" }] }
        ],
        day5: [
            { text: "🤴 عاشقتم... این اولین باره که اینو می‌گم", options: [{ text: "💋 منم عاشقتم", action: "kiss" }, { text: "🔥 بیا", action: "seduce" }, { text: "🎁 هدیه", action: "gift" }] },
            { text: "🤴 می‌خوام تاجم رو با تو تقسیم کنم", options: [{ text: "👑 قبول", action: "propose" }, { text: "💋 فقط تو رو می‌خوام", action: "kiss" }, { text: "🔙 بعداً", action: "flee" }] }
        ],
        day6: [
            { text: "🤴 امشب شاهزاده نیستم... فقط مال توام", options: [{ text: "🔥 از جلو", action: "seduce" }, { text: "🍑 از پشت", action: "seduce" }, { text: "👄 دهنی", action: "kiss" }] },
            { text: "🤴 توی قصر یادم دادن چطور عشق‌بازی کنم", options: [{ text: "💋 نشون بده", action: "kiss" }, { text: "🔥 بکنم", action: "seduce" }, { text: "🔙 بعداً", action: "flee" }] }
        ],
        day7: [
            { text: "🤴 تا ابد شاهزاده تو می‌مونم", options: [{ text: "💋 تا ابد", action: "kiss" }, { text: "👰 ازدواج سلطنتی", action: "propose" }, { text: "🔥 بیا", action: "seduce" }] },
            { text: "🤴 تاج و تخت برام مهم نیست... فقط تو", options: [{ text: "💋 عاشقتم", action: "kiss" }, { text: "🔥 بکنم", action: "seduce" }, { text: "👶 بچه سلطنتی", action: "seduce" }] }
        ],
        harem: [
            { text: "🤴 شوهرم... امروز می‌خوام برات برقصم", options: [{ text: "💃 برقص", action: "ally" }, { text: "💋 بیا", action: "kiss" }, { text: "🔥 بکنم", action: "seduce" }] }
        ]
    }
};
    ...
    sage: {
        day1: [
            { text: "🧙 سلام مسافر... آینده‌ات رو توی چشمات می‌بینم", options: [{ text: "🔮 فال بگیر", action: "listen" }, { text: "💡 راهنمایی", action: "help" }, { text: "🏃 فرار", action: "flee" }] },
            { text: "🧙 حکمت باستانی رو می‌تونم بهت یاد بدم", options: [{ text: "📚 یاد بده", action: "help" }, { text: "💋 چیز دیگه", action: "seduce" }, { text: "🏃 فرار", action: "flee" }] }
        ],
        day2: [
            { text: "🧙 دوباره اومدی... سوال داری؟", options: [{ text: "🔮 فال", action: "listen" }, { text: "💋 مشاوره", action: "seduce" }, { text: "🏃 فرار", action: "flee" }] },
            { text: "🧙 کتابای زیادی خوندم... ولی عشق رو نه", options: [{ text: "💋 یاد بدم", action: "kiss" }, { text: "📚 بخون", action: "help" }, { text: "🏃 فرار", action: "flee" }] }
        ],
        day3: [
            { text: "🧙 قلبم تند می‌زنه... این نشونه چیه؟", options: [{ text: "💋 عشقه", action: "kiss" }, { text: "🤝 استرس", action: "ally" }, { text: "🔙 بعداً", action: "flee" }] },
            { text: "🧙 شاید کتابا همه چیز رو نگن", options: [{ text: "💋 عشق توی کتاب نیست", action: "seduce" }, { text: "📚 هست", action: "help" }, { text: "🔙 بعداً", action: "flee" }] }
        ],
        day4: [
            { text: "🧙 می‌خوام بیشتر بدونم... درباره تو", options: [{ text: "💋 بپرس", action: "kiss" }, { text: "🤝 بگو", action: "ally" }, { text: "🔙 بعداً", action: "flee" }] },
            { text: "🧙 عشق مثل یه معمای باستانیه", options: [{ text: "💋 حلش کن", action: "seduce" }, { text: "📚 تحقیق کن", action: "help" }, { text: "🔙 بعداً", action: "flee" }] }
        ],
        day5: [
            { text: "🧙 فکر کنم عاشق شدم", options: [{ text: "💋 منم", action: "kiss" }, { text: "🤝 جدی؟", action: "ally" }, { text: "🎁 هدیه", action: "gift" }] },
            { text: "🧙 می‌خوام بقیه عمرم رو با تو باشم", options: [{ text: "💋 بمون", action: "kiss" }, { text: "🔥 بیا", action: "seduce" }, { text: "🔙 بعداً", action: "flee" }] }
        ],
        day6: [
            { text: "🧙 امروز می‌خوام چیز جدید یاد بدم", options: [{ text: "🔥 از جلو", action: "seduce" }, { text: "🍑 از پشت", action: "seduce" }, { text: "👄 دهنی", action: "kiss" }] },
            { text: "🧙 حکمت عشق... از همه کتابا مهم‌تره", options: [{ text: "🔥 یاد بده", action: "seduce" }, { text: "💋 ببوس", action: "kiss" }, { text: "🔙 بعداً", action: "flee" }] }
        ],
        day7: [
            { text: "🧙 تا ابد حکیم تو می‌مونم", options: [{ text: "💋 تا ابد", action: "kiss" }, { text: "👰 ازدواج", action: "propose" }, { text: "🔥 بیا", action: "seduce" }] },
            { text: "🧙 آخرین درس... درس عشق", options: [{ text: "💋 یاد بگیرم", action: "kiss" }, { text: "🔥 بکنم", action: "seduce" }, { text: "👶 بچه حکیم", action: "seduce" }] }
        ]
    },
    farmer: {
        day1: [{ text: "🧑‍🌾 سلام جوون! گرسنه‌ای؟ غذا دارم", options: [{ text: "🍖 بخرم", action: "trade" }, { text: "🤝 کمک", action: "help" }, { text: "🏃 فرار", action: "flee" }] }],
        day2: [{ text: "🧑‍🌾 دوباره اومدی؟ بازم غذا می‌خوای؟", options: [{ text: "🍖 آره", action: "trade" }, { text: "💋 دیدن تو", action: "seduce" }, { text: "🏃 فرار", action: "flee" }] }],
        day3: [{ text: "🧑‍🌾 دلم می‌خواد یکی کنارم باشه", options: [{ text: "💋 من هستم", action: "kiss" }, { text: "🤝 دوست", action: "ally" }, { text: "🔙 بعداً", action: "flee" }] }],
        day4: [{ text: "🧑‍🌾 شاید زندگی فقط کشاورزی نیست", options: [{ text: "💋 عشق هم هست", action: "seduce" }, { text: "🤝 چیه؟", action: "ally" }, { text: "🔙 بعداً", action: "flee" }] }],
        day5: [{ text: "🧑‍🌾 عاشقتم... ساده و صادقانه", options: [{ text: "💋 منم", action: "kiss" }, { text: "🔥 بیا", action: "seduce" }, { text: "🎁 هدیه", action: "gift" }] }],
        day6: [{ text: "🧑‍🌾 امشب می‌خوام بکارمت", options: [{ text: "🔥 از جلو", action: "seduce" }, { text: "🍑 از پشت", action: "seduce" }, { text: "👄 دهنی", action: "kiss" }] }],
        day7: [{ text: "🧑‍🌾 تا ابد کشاورز عاشق تو", options: [{ text: "💋 تا ابد", action: "kiss" }, { text: "👶 بچه‌دار شیم", action: "seduce" }, { text: "🔥 بیا", action: "seduce" }] }]
    },
    blacksmith: {
        day1: [{ text: "⚒️ به کارگاه من خوش اومدی! چی می‌خوای بسازی؟", options: [{ text: "🔨 ساخت", action: "craft" }, { text: "🤝 صحبت", action: "ally" }, { text: "🏃 فرار", action: "flee" }] }],
        day2: [{ text: "⚒️ بازم اومدی؟ می‌خوای یه چیز جدید بسازیم؟", options: [{ text: "🔨 آره", action: "craft" }, { text: "💋 چیز دیگه", action: "seduce" }, { text: "🏃 فرار", action: "flee" }] }],
        day3: [{ text: "⚒️ وقتی میای دلم گرم میشه... مثل کوره", options: [{ text: "💋 منم", action: "kiss" }, { text: "🤝 جالبه", action: "ally" }, { text: "🔙 بعداً", action: "flee" }] }],
        day4: [{ text: "⚒️ دلم می‌خواد برات یه چیز خاص بسازم", options: [{ text: "💋 قلبم رو بساز", action: "seduce" }, { text: "⚔️ شمشیر", action: "craft" }, { text: "🔙 بعداً", action: "flee" }] }],
        day5: [{ text: "⚒️ عاشقتم... محکم مثل فولاد", options: [{ text: "💋 منم", action: "kiss" }, { text: "🔥 بیا", action: "seduce" }, { text: "🎁 هدیه", action: "gift" }] }],
        day6: [{ text: "⚒️ امشب می‌خوام چکش‌کاریت کنم", options: [{ text: "🔥 از جلو", action: "seduce" }, { text: "🍑 از پشت", action: "seduce" }, { text: "👄 دهنی", action: "kiss" }] }],
        day7: [{ text: "⚒️ تا ابد آهنگر تو می‌مونم", options: [{ text: "💋 تا ابد", action: "kiss" }, { text: "👶 بچه‌دار شیم", action: "seduce" }, { text: "🔥 بیا", action: "seduce" }] }]
    },
    merchant: {
        day1: [{ text: "🧑‍🌾 جنس دارم، جنس مرغوب! از شیراز آوردیم!", options: [{ text: "💰 خرید", action: "trade" }, { text: "🤝 تخفیف", action: "gift" }, { text: "🏃 فرار", action: "flee" }] }],
        day2: [{ text: "🧑‍🌾 بازم اومدی؟ خریدار خوبی هستی", options: [{ text: "💰 خرید", action: "trade" }, { text: "💋 مشتری خاص", action: "seduce" }, { text: "🏃 فرار", action: "flee" }] }],
        day3: [{ text: "🧑‍🌾 بهت تخفیف می‌دم... چون خاصی", options: [{ text: "💰 ممنون", action: "trade" }, { text: "💋 چرا خاصم؟", action: "seduce" }, { text: "🔙 بعداً", action: "flee" }] }],
        day4: [{ text: "🧑‍🌾 قلبم رو نمی‌تونم بفروشم... ولی به تو می‌دم", options: [{ text: "💋 می‌گیرم", action: "kiss" }, { text: "💰 چند؟", action: "trade" }, { text: "🔙 بعداً", action: "flee" }] }],
        day5: [{ text: "🧑‍🌾 عاشقتم... این از همه جنسام باارزش‌تره", options: [{ text: "💋 منم", action: "kiss" }, { text: "🔥 بیا", action: "seduce" }, { text: "🎁 هدیه", action: "gift" }] }],
        day6: [{ text: "🧑‍🌾 امشب می‌خوام حسابت رو برسم", options: [{ text: "🔥 از جلو", action: "seduce" }, { text: "🍑 از پشت", action: "seduce" }, { text: "👄 دهنی", action: "kiss" }] }],
        day7: [{ text: "🧑‍🌾 تا ابد تاجر عاشق تو", options: [{ text: "💋 تا ابد", action: "kiss" }, { text: "👶 بچه‌دار شیم", action: "seduce" }, { text: "🔥 بیا", action: "seduce" }] }]
    },
    maid: {
        day1: [{ text: "🧹 قربان... اتاقتون رو تمیز کردم", options: [{ text: "🤝 ممنون", action: "ally" }, { text: "💋 نزدیک شو", action: "seduce" }, { text: "🏃 فرار", action: "flee" }] }],
        day2: [{ text: "🧹 قربان... بازم اینجایید؟ خوشحالم", options: [{ text: "💋 منم خوشحالم", action: "kiss" }, { text: "🤝 کار داری؟", action: "ally" }, { text: "🏃 فرار", action: "flee" }] }],
        day3: [{ text: "🧹 قربان... می‌تونم یه خواهش کنم؟", options: [{ text: "💋 بگو", action: "kiss" }, { text: "🤝 بگو", action: "ally" }, { text: "🔙 بعداً", action: "flee" }] }],
        day4: [{ text: "🧹 قربان... امشب هم می‌تونم بمونم؟", options: [{ text: "💋 بمون", action: "kiss" }, { text: "🤝 نه", action: "ally" }, { text: "🔙 بعداً", action: "flee" }] }],
        day5: [{ text: "🧹 قربان... عاشقتون شدم", options: [{ text: "💋 منم", action: "kiss" }, { text: "🔥 بیا", action: "seduce" }, { text: "🎁 هدیه", action: "gift" }] }],
        day6: [{ text: "🧹 امروز می‌خوام خدمت ویژه بدم", options: [{ text: "🔥 از جلو", action: "seduce" }, { text: "🍑 از پشت", action: "seduce" }, { text: "👄 دهنی", action: "kiss" }] }],
        day7: [{ text: "🧹 تا ابد کلفت عاشق شما", options: [{ text: "💋 تا ابد", action: "kiss" }, { text: "👶 بچه‌دار شیم", action: "seduce" }, { text: "🔥 بیا", action: "seduce" }] }]
    },
    cook: {
        day1: [{ text: "👩‍🍳 قربان... غذاتون حاضره", options: [{ text: "🍖 بخورم", action: "ally" }, { text: "💋 تو چی می‌خوری؟", action: "seduce" }, { text: "🏃 فرار", action: "flee" }] }],
        day2: [{ text: "👩‍🍳 قربان... غذاتون رو با عشق پختم", options: [{ text: "💋 حس می‌کنم", action: "kiss" }, { text: "🤝 ممنون", action: "ally" }, { text: "🏃 فرار", action: "flee" }] }],
        day3: [{ text: "👩‍🍳 قربان... امشب شام مخصوص داریم", options: [{ text: "🍖 چیه؟", action: "ally" }, { text: "💋 خودت چی؟", action: "seduce" }, { text: "🔙 بعداً", action: "flee" }] }],
        day4: [{ text: "👩‍🍳 قربان... عشق مثل آشپزیه", options: [{ text: "💋 با حرارت", action: "kiss" }, { text: "🤝 توضیح بده", action: "ally" }, { text: "🔙 بعداً", action: "flee" }] }],
        day5: [{ text: "👩‍🍳 عاشقتون شدم... مثل عسل شیرین", options: [{ text: "💋 منم", action: "kiss" }, { text: "🔥 بیا", action: "seduce" }, { text: "🎁 هدیه", action: "gift" }] }],
        day6: [{ text: "👩‍🍳 امروز غذای مخصوص... خودم", options: [{ text: "🔥 از جلو", action: "seduce" }, { text: "🍑 از پشت", action: "seduce" }, { text: "👄 دهنی", action: "kiss" }] }],
        day7: [{ text: "👩‍🍳 تا ابد آشپز عاشق شما", options: [{ text: "💋 تا ابد", action: "kiss" }, { text: "👶 بچه‌دار شیم", action: "seduce" }, { text: "🔥 بیا", action: "seduce" }] }]
    },
    stylist: {
        day1: [{ text: "💇 قربان... موهاتون رو آرایش کنم؟", options: [{ text: "💇 آره", action: "ally" }, { text: "💋 اول ببوس", action: "seduce" }, { text: "🏃 فرار", action: "flee" }] }],
        day2: [{ text: "💇 قربان... امروز چهره‌تون می‌درخشه", options: [{ text: "💋 از عشقه", action: "kiss" }, { text: "🤝 ممنون", action: "ally" }, { text: "🏃 فرار", action: "flee" }] }],
        day3: [{ text: "💇 دلم می‌خواد فقط شما رو آرایش کنم", options: [{ text: "💋 فقط من", action: "seduce" }, { text: "🤝 چرا؟", action: "ally" }, { text: "🔙 بعداً", action: "flee" }] }],
        day4: [{ text: "💇 قربان... دلم می‌خواد آرایش خاص بکنم", options: [{ text: "💋 بکن", action: "kiss" }, { text: "🤝 چه آرایشی؟", action: "ally" }, { text: "🔙 بعداً", action: "flee" }] }],
        day5: [{ text: "💇 عاشقتون شدم", options: [{ text: "💋 منم", action: "kiss" }, { text: "🔥 بیا", action: "seduce" }, { text: "🎁 هدیه", action: "gift" }] }],
        day6: [{ text: "💇 امروز آرایش مخصوص", options: [{ text: "🔥 از جلو", action: "seduce" }, { text: "🍑 از پشت", action: "seduce" }, { text: "👄 دهنی", action: "kiss" }] }],
        day7: [{ text: "💇 تا ابد آرایشگر عاشق شما", options: [{ text: "💋 تا ابد", action: "kiss" }, { text: "👶 بچه‌دار شیم", action: "seduce" }, { text: "🔥 بیا", action: "seduce" }] }]
    },
    tailor: {
        day1: [{ text: "👗 قربان... براتون لباس بدوزم؟", options: [{ text: "👗 آره", action: "ally" }, { text: "💋 اندازه بگیر", action: "seduce" }, { text: "🏃 فرار", action: "flee" }] }],
        day2: [{ text: "👗 قربان... اندامتون رو اندازه گرفتم", options: [{ text: "💋 خوبه", action: "kiss" }, { text: "🤝 ممنون", action: "ally" }, { text: "🏃 فرار", action: "flee" }] }],
        day3: [{ text: "👗 دلم می‌خواد فقط براتون بدوزم", options: [{ text: "💋 فقط برای من", action: "seduce" }, { text: "🤝 چرا؟", action: "ally" }, { text: "🔙 بعداً", action: "flee" }] }],
        day4: [{ text: "👗 قربان... می‌خوام لباس خاص براتون بدوزم", options: [{ text: "💋 بذوز", action: "kiss" }, { text: "🤝 چه لباسی؟", action: "ally" }, { text: "🔙 بعداً", action: "flee" }] }],
        day5: [{ text: "👗 عاشقتون شدم", options: [{ text: "💋 منم", action: "kiss" }, { text: "🔥 بیا", action: "seduce" }, { text: "🎁 هدیه", action: "gift" }] }],
        day6: [{ text: "👗 امروز لباس مخصوص", options: [{ text: "🔥 از جلو", action: "seduce" }, { text: "🍑 از پشت", action: "seduce" }, { text: "👄 دهنی", action: "kiss" }] }],
        day7: [{ text: "👗 تا ابد خیاط عاشق شما", options: [{ text: "💋 تا ابد", action: "kiss" }, { text: "👶 بچه‌دار شیم", action: "seduce" }, { text: "🔥 بیا", action: "seduce" }] }]
    },
    guard: {
        day1: [{ text: "🛡️ قربان... محافظت از شما وظیفه‌مه", options: [{ text: "🤝 ممنون", action: "ally" }, { text: "💋 فقط وظیفه‌ست؟", action: "seduce" }, { text: "🏃 فرار", action: "flee" }] }],
        day2: [{ text: "🛡️ قربان... جونم رو براتون می‌دم", options: [{ text: "💋 چرا؟", action: "kiss" }, { text: "🤝 وظیفه‌ست", action: "ally" }, { text: "🏃 فرار", action: "flee" }] }],
        day3: [{ text: "🛡️ دلم می‌خواد بیشتر از محافظ باشم", options: [{ text: "💋 باش", action: "seduce" }, { text: "🤝 چطور؟", action: "ally" }, { text: "🔙 بعداً", action: "flee" }] }],
        day4: [{ text: "🛡️ قربان... می‌خوام شبانه‌روز محافظت کنم", options: [{ text: "💋 محافظت کن", action: "kiss" }, { text: "🤝 شبم؟", action: "ally" }, { text: "🔙 بعداً", action: "flee" }] }],
        day5: [{ text: "🛡️ عاشقتون شدم", options: [{ text: "💋 منم", action: "kiss" }, { text: "🔥 بیا", action: "seduce" }, { text: "🎁 هدیه", action: "gift" }] }],
        day6: [{ text: "🛡️ امروز محافظت ویژه", options: [{ text: "🔥 از جلو", action: "seduce" }, { text: "🍑 از پشت", action: "seduce" }, { text: "👄 دهنی", action: "kiss" }] }],
        day7: [{ text: "🛡️ تا ابد محافظ عاشق شما", options: [{ text: "💋 تا ابد", action: "kiss" }, { text: "👶 بچه‌دار شیم", action: "seduce" }, { text: "🔥 بیا", action: "seduce" }] }]
    }
};
